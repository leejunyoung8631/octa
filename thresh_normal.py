...
Original file is located at
    https://colab.research.google.com/drive/1MVACcOW62grZkdm08iswKnWC8e4tOH4t
"""
...
save_path = "/content/drive/My Drive/thre_imgs/"
    ...
    for i in range(3):
      for j in range(304):
        for k in range(304):
          ...
          if (file.split("_")[2] == "DCP"):
            thre = 0.6
          else:
            thre = 0.4
          img[j,k,i] = 0 if img[j,k,i] < thre else 1
    
    img = img * 255
    path_save_name = save_path + file
...
# register trainset
register_coco_instances("dataset_train0", {}, "train_0.json", "/content/drive/My Drive/thre_imgs")
register_coco_instances("dataset_val0", {}, "val_0.json", "/content/drive/My Drive/thre_imgs")

register_coco_instances("dataset_train1", {}, "train_1.json", "/content/drive/My Drive/thre_imgs")
register_coco_instances("dataset_val1", {}, "val_1.json", "/content/drive/My Drive/thre_imgs")

register_coco_instances("dataset_train2", {}, "train_2.json", "/content/drive/My Drive/thre_imgs")
register_coco_instances("dataset_val2", {}, "val_2.json", "/content/drive/My Drive/thre_imgs")
...
# my_dataset_train_metadata = MetadataCatalog.get("dataset_train0")
# dataset_dicts = DatasetCatalog.get("dataset_train0")

# for imageName in glob.glob('/content/patches/*png'):
...
for images in ddd["images"]:
  k = "/content/drive/My Drive/thre_imgs/" + images["file_name"]
  name_list.append(k)
print(len(name_list))
print(name_list)


for imageName in glob.glob('/content/drive/My Drive/thre_imgs/*png'):
  if (imageName in name_list):
    ...
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/thre_ori_0/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
...
y_dataset_train_metadata = MetadataCatalog.get("dataset_train1")
dataset_dicts = DatasetCatalog.get("dataset_train1")
...
for imageName in glob.glob('/content/drive/My Drive/thre_imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/thre_ori_1/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
...
my_dataset_train_metadata = MetadataCatalog.get("dataset_train2")
dataset_dicts = DatasetCatalog.get("dataset_train2")
...
for imageName in glob.glob('/content/drive/My Drive/thre_imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/thre_ori_2/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
