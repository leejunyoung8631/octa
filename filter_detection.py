# -*- coding: utf-8 -*-
"""filter_detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/178vqmo8KFCdSm-NqYEWEqJ6_7FjtqOIh
"""
...
# register trainset
register_coco_instances("dataset_train0", {}, "train_0.json", "/content/drive/My Drive/filter_imgs")
register_coco_instances("dataset_val0", {}, "val_0.json", "/content/drive/My Drive/filter_imgs")

register_coco_instances("dataset_train1", {}, "train_1.json", "/content/drive/My Drive/filter_imgs")
register_coco_instances("dataset_val1", {}, "val_1.json", "/content/drive/My Drive/filter_imgs")

register_coco_instances("dataset_train2", {}, "train_2.json", "/content/drive/My Drive/filter_imgs")
register_coco_instances("dataset_val2", {}, "val_2.json", "/content/drive/My Drive/filter_imgs")
...
for images in ddd["images"]:
  k = "/content/drive/My Drive/filter_imgs/" + images["file_name"]
  name_list.append(k)
print(len(name_list))
print(name_list)


for imageName in glob.glob('/content/drive/My Drive/filter_imgs/*png'):
  if (imageName in name_list):
    ...
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/filter_0/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
...
my_dataset_train_metadata = MetadataCatalog.get("dataset_train1")
...
for imageName in glob.glob('/content/drive/My Drive/filter_imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/filter_1/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
...
for imageName in glob.glob('/content/drive/My Drive/filter_imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/filter_2/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
