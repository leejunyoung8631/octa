# -*- coding: utf-8 -*-
"""Basic_RetinaNet.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NePwaZi7VEL6ihPF3dlsMWNy2mtM_45x
"""
...
for images in ddd["images"]:
  k = "/content/drive/My Drive/imgs/" + images["file_name"]
  name_list.append(k)
print(len(name_list))
print(name_list)


for imageName in glob.glob('/content/drive/My Drive/imgs/*png'):
...
for imageName in glob.glob('/content/drive/My Drive/imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/retina_1/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
...
for imageName in glob.glob('/content/drive/My Drive/imgs/*png'):
  if (imageName in name_list):
    ...
    re = Image.fromarray(aa.astype(np.uint8))
    mm = N.split("/")[-1]
    path_save_name = "/content/drive/My Drive/retina_2/" + mm
    re.save(path_save_name)
    plt.imshow(aa)
